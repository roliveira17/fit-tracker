...
export function WorkoutCard({
  ...
  return (
    <>
      ...
      <div className="-mx-5 -mt-5 h-32 relative overflow-hidden">
      ...
      <div className="pt-4 flex flex-col gap-4">
        <div>
          <h2 className="text-[#3E2723] text-[1.75rem] font-bold leading-tight">
            Treino Registrado
          </h2>
          {workoutTitle && (
        ...
        {exercises.length > 0 && (
          <div className="flex flex-col gap-3">
            <p className="text-[#3E2723] font-medium text-base">Exercicios:</p>
            <div className="flex flex-wrap gap-2">
              {exercises.map((exercise, i) => (
                <span
                  key={i}
                  className="inline-flex items-center px-3 py-1.5 rounded-full bg-[#3E2723]/5 text-[#3E2723] text-sm font-medium border border-[#3E2723]/10"
                >
                  {exercise.name}
                </span>
              ))}
        ...
        {/* Edit button */}
        <button className="mt-1 w-full py-3 rounded-xl bg-[#3E2723]/5 text-[#3E2723] text-sm font-medium hover:bg-[#3E2723]/10 transition-colors flex items-center justify-center gap-2">
